 ...
 */
@Data
@Schema(description = "Payload for updating an existing employee record. Only provided fields are updated.")
public class UpdateEmployeeRequest {
    ...
    @Schema(description = "Department the employee belongs to", example = "Product")
    private String department;

    @Size(max = 150, message = "Job title must not exceed 150 characters")
    @Schema(description = "Employee job title", example = "Staff Engineer")
    ...
    @Schema(description = "Annual gross salary", example = "105000.00")
